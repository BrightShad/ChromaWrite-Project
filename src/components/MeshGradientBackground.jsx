...
const MeshGradientBackground = ({ activeColor }) => /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-0 overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-background" }), /* @__PURE__ */ React.createElement(
  motion.div,
  {
...
), blobs.map((blob, i) => /* @__PURE__ */ React.createElement(
  motion.div,
  {
    key: i,
