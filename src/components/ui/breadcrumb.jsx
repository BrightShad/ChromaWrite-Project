...
const BreadcrumbSeparator = ({ children, className, ...props }) => /* @__PURE__ */ React.createElement("li", { role: "presentation", "aria-hidden": "true", className: cn("[&>svg]:size-3.5", className), ...props }, children ?? /* @__PURE__ */ React.createElement(ChevronRight, null));
